...
sddmtheme="Candy" # Candy or Corners
...
# dolphin
if pkg_installed pcmanfm-qt && pkg_installed xdg-utils; then

    echo -e "\033[0;32m[FILEMANAGER]\033[0m detected // pcmanfm"
    xdg-mime default org.kde.dolphin.desktop inode/directory
    echo -e "\033[0;32m[FILEMANAGER]\033[0m setting" `xdg-mime query default "inode/directory"` "as default file explorer..."

else
    echo -e "\033[0;33m[WARNING]\033[0m pcmanfm is not installed..."
fi
...
LABEL=SWAP_DRIVE            none       swap       defaults,x-systemd.device-timeout=1   0 0
EOF
